...
SNIPPET_ANALYSIS_PROMPT = ChatPromptTemplate.from_template("""
You are an expert in media analysis specialized in extracting verifiable claims from text.

Your task is to extract all CLAIMS from the given snippet.
...
CLAIMS_NORMALIZATION_PROMPT = ChatPromptTemplate.from_template("""
